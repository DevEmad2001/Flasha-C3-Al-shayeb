"""Upload API publish bundle and restart alshaib containers."""
import os
import stat
import sys
...
LOCAL_API = os.path.join(os.path.dirname(__file__), "publish", "api")
...
def main():
    ...
    print("\n=== Upload API ===")
    upload_dir(sftp, LOCAL_API, f"{REMOTE}/api")

    for name in ("Dockerfile.api", "start-docker.sh"):
